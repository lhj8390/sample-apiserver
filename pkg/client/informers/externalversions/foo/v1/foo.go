...
import (
	"context"
	foov1 "sample-apiserver/pkg/apis/foo/v1"
	versioned "sample-apiserver/pkg/client/clientset/versioned"
	internalinterfaces "sample-apiserver/pkg/client/informers/externalversions/internalinterfaces"
	v1 "sample-apiserver/pkg/client/listers/foo/v1"
	time "time"
