...
import (
	...
	json "encoding/json"
	"fmt"
	v1 "sample-apiserver/pkg/apis/foo/v1"
	foov1 "sample-apiserver/pkg/client/applyconfiguration/foo/v1"
	scheme "sample-apiserver/pkg/client/clientset/versioned/scheme"
	"time"
