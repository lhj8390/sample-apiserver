...
mkdir -p ${goPath}/src/sample-apiserver
cp -R . ${goPath}/src/sample-apiserver

pushd ${goPath}/src/sample-apiserver
rm -rf vendor || true
...
mv ${goPath}/src/sample-apiserver/vendor .
mv ${goPath}/src/sample-apiserver/Godeps .
git add vendor
git add Godeps
